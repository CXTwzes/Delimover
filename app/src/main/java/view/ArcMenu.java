...
{
	private static final int POS_LEFT_CENTER = 0;

	private Position mPosition = Position.LEFT_CENTER;
	private int mRadius;
	/**
	 * 菜单的状态
	 */
	...
	public ArcMenu(Context context, AttributeSet attrs, int defStyle) {
		...
		int pos = a.getInt(R.styleable.ArcMenu_position, POS_LEFT_CENTER);
